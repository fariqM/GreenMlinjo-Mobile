<template>
	<div class="d-flex justify-space-around py-1 px-1">
		<skeleton height="4.4rem" width="50%" v-if="skeleton && balance == null" :radius="3" />

		<v-card class="d-flex align-center pa-3" elevation="2" v-if="!skeleton && balance!==null && isLogedIn">
